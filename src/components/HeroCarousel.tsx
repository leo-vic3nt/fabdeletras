  ...
  return (
    ...
    >
      <CarouselContent>
        ...
        >
          <div className="lg:pt-20 pt-10 flex flex-col gap-5 absolute left-0 right-0 lg:right-1/3 lg:top-1/5 w-[clamp(300px,80%,500px)] mx-auto">
        ...
        <CarouselItem className="h-[915px] lg:h-[769px] bg-[url(src/assets/banners/banner-hero-mobile-02.png)] lg:bg-[url(src/assets/banners/banner-hero-02-min.png)] bg-no-repeat bg-cover bg-center relative">
          <div className="lg:pt-20 pt-10 flex flex-col gap-5 absolute left-0 right-0 lg:right-1/3 w-[clamp(300px,80%,500px)] mx-auto">
        ...
        <CarouselItem
          ...
          bg-no-repeat bg-cover bg-center flex relative"
        >
          <div className="lg:pt-20 pt-10 flex flex-col gap-5 absolute left-0 right-0 lg:right-1/2 lg:top-1/4 w-[clamp(300px,80%,500px)] mx-auto">
            <h1 className="font-blackcrow text-white lg:text-4xl text-2xl font-bold">
